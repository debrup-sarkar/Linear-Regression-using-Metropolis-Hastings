...
## See Also
- [Robust Adaptive Metropolis for parameter estimation in Linear Model](https://github.com/debrup-sarkar/Linear-Regression-using-Robust-Adaptive-Metropolis-MCMC-algorithm-in-MATLAB): This repository contains an implementation of the Robust Adaptive Metropolis algorithm for parameter estimation in linear models using MATLAB.
